...
const MAT_DATA = [
  ...
  { id: 2, size: "60×40", name: "Pierre de Bourgogne adoucie", marque: "Carrières Sauvanet", ref: "PBG-060-ADO", cat: "Sols", prix: "146 €/m²", delai: "6 sem.", projets: ["Grange Lissieu", "Maison Écully"], champ: true, bg: "radial-gradient(ellipse at 30% 30%, #C7CCD7, transparent 60%), linear-gradient(135deg, #BCC1CE, #858FA7)" },
  ...
  { id: 5, name: "Enduit chaux ferré sable", marque: "Argilus", ref: "ECF-010-SAB", cat: "Murs & peintures", prix: "46 €/m²", delai: "1 sem.", projets: ["Grange Lissieu", "Maison Écully"], champ: true, tags: ["biosourcé"], bg: "radial-gradient(ellipse at 40% 60%, rgba(255,255,255,0.25), transparent 55%), linear-gradient(135deg, #D5D9E1, #AEB5C5)" },
  { id: 6, name: "Chanvre projeté isolant", marque: "Technichanvre", ref: "CHP-200-ISO", cat: "Murs & peintures", prix: "39 €/m²", delai: "2 sem.", projets: [], tags: ["biosourcé", "isolant"], bg: "radial-gradient(ellipse at 30% 70%, rgba(200,190,150,0.3), transparent 50%), linear-gradient(135deg, #919AAF, #8F865F)" },
  { id: 7, size: "H240×L60", name: "Menuiserie noyer fumé huilé", marque: "Scierie Delatour", ref: "NYF-180-FUM", cat: "Menuiseries", prix: "128 €/m²", delai: "5 sem.", projets: ["Atelier Paris 11e"], bg: "repeating-linear-gradient(90deg, rgba(30,15,5,0.2) 0 2px, transparent 2px 9px), linear-gradient(135deg, #7A5636, #2D323D)" },
