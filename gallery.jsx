...
const Gallery = () => {
  ...
  const tiles = [
    ...
    { cls: "g-3", img: "images/escalier-spirale.jpg", sizes: "(max-width: 760px) 94vw, 390px",   eyebrow: L("DÉTAIL D'EXÉCUTION", "CONSTRUCTION DETAIL"),        h: L("Escalier hélicoïdal, béton & chêne", "Spiral staircase, concrete & oak"), alt: "Escalier en spirale vu du dessus, béton et bois",  gain: L("Une seule version du détail : celle qui a été validée", "One version of the detail: the one that was approved") },
    { cls: "g-5", img: "images/villa-interieur.jpg", sizes: "(max-width: 760px) 94vw, 790px",    eyebrow: L("LIVRAISON", "DELIVERED"),                h: L("Villa contemporaine, bois & lumière", "Contemporary villa, timber & light"), alt: "Intérieur de villa contemporaine, plafond bois et grandes baies",  gain: L("Le PV de réception signé le jour même, diffusé à tous", "Handover report signed the same day, sent to everyone") },
  ];
  return (
